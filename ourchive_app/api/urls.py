...
urlpatterns = [
    ...
    path('chapters/<int:chapter_id>/comments/', views.ChapterCommentDetail.as_view(), name='chapter-comment-detail'),
    ...
    path('bookmarks/<int:bookmark_id>/comments', views.BookmarkCommentDetail.as_view(), name='bookmark-comment-detail'),
